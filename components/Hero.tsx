    ...
    <>
      <section className="relative w-[1440px] h-[796px] overflow-hidden">
        ...
        >
          ...
          <div
            className="box-border flex w-[1240px] h-[436px] gap-[36px] px-[16px] opacity-100"
            style={{
              transform: "rotate(0deg)",
            }}
          >
              ...
              >
                ...
                <div className="h-[364.94px] w-[424.84px]">
                  ...
                  <div className="flex h-[73px] w-[424.844px] flex-col gap-[10px] pt-[18px]">
                    <div className="relative flex h-[55px] w-[424.844px] justify-between border-t-[2px] border-dashed border-[#B249244D] pt-[14px]">
